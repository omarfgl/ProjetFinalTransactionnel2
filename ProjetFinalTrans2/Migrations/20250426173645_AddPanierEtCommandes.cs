...
{
    /// <inheritdoc />
    public partial class AddPanierEtCommandes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_Realisations_ProduitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Realisations_RealisationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_RealisationId",
                table: "OrderItems",
